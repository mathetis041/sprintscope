        ...
        <div className="min-h-screen flex justify-center items-center md:bg-[#cadfd0]">
            <div className="md:w-1/2 md:rounded-xl md:bg-[#FFFFFF]">
                <div className="flex flex-col items-center justify-center text-center py-10 md:m-auto lg:w-2/3 xl:w-1/2">
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); handleSignupData() }} className="w-full p-4 bg-white">
                        <div className="text-left mb-5">
                            ...
                            <input type="text"
                                ...
                                className={`w-full placeholder:text-gray-500 px-3 py-2 border text-sm rounded-md focus:outline-none ${nameWarning ? "border-red-500" : "border-gray-300"}`}
                            />
                        ...
                        <button type="submit" className="bg-[#F97316] w-full text-white py-2 rounded-sm mb-5">
                            Sign Up
                        </button>
                        <div className="flex justify-center items-center gap-2 text-sm">
                            <p>Already have an account?</p>
                            <Link to="/login" className="text-[#F97316]">Login</Link>
                        </div>
                    </form>
                </div>
            </div>
